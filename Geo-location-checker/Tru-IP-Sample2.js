...
// usage:  geo_location_checker=http://ip-api.com/json/?fields=21753855&lang=zh-CN,https://raw.githubusercontent.com/Tru-tru/QuantumultX/main/IP.js
...
const subtitle = `${geticon(obj.proxy, '⚠︎') + geticon(obj.hosting, '🅗') + obj.isp}  ➤ ${placeAdder(obj.country)}${placeAdder(obj.regionName)}${placeAdder(obj.city)}${placeAdder(obj.district)}  ➤  ${obj.query}`;
const ip = obj.query;
